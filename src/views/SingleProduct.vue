...
<template>
    <section class="relative max-w-5xl mx-auto my-16">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 mx-auto max-md:px-2 ">
                ...
                <div
                    ...
                    <div class="data w-full max-w-xl">
                        <p class="font-medium leading-8 text-indigo-600 mb-4 uppercase">{{ product.category }}
                        </p>
                        ...
                        <div class="flex flex-col sm:flex-row sm:items-center mb-6">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <span class="pl-2 font-normal leading-7 text-gray-500 text-sm ">{{ product.rating?.count }} review</span>
                            </div>
